...
train_dataset = datasets.ImageFolder(root=r'/home/liese2/ANN_project/Datasets/Dataset_nov_224/Training', transform=transform)
test_dataset = datasets.ImageFolder(root=r'/home/liese2/ANN_project/Datasets/Dataset_nov_224/Test', transform=transform)
...
log_path = f"training_log_resnet50pt.txt"

with open(log_path, 'w') as log_file:
    log_file.write(f"Entrenamiento iniciado: {datetime.now()}\n")
    log_file.write(f"Device: {device} | Epochs: {num_epochs} | Batch size: {batch_size}\n")
    log_file.write("-" * 70 + "\n")
    ...
    log_file.write("-" * 70 + "\n")
    log_file.write(f"Entrenamiento finalizado: {datetime.now()}\n")
...
ov.save_model(ov_model, f"{output_dir}/modelo_resnet50.xml")
